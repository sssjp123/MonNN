...
def optimize_hyperparameters(X, y, task_type, mono_idx, current_lambda):
    study = optuna.create_study(direction="minimize",
                                sampler=optuna.samplers.TPESampler(seed=GLOBAL_SEED))

    study.optimize(lambda trial: objective(trial, X, y, task_type, mono_idx, current_lambda),
...
def process_dataset(loader: Callable, current_lambda):
    ...
    best_config = optimize_hyperparameters(X, y, task_type, mono_idx, current_lambda)
