...
def main():
    ...
    csv_files = [
        'exps_MLP.csv', 'exps_WeightsConstrained.csv', 'exps_MM.csv',
        'exps_SMM.csv', 'exps_HLL.csv', 'exps_UMNN.csv', 'exps_LMN.csv', 'exps_CoMNN.csv', 'exps_SMNN.csv'
    ]
    ...
    try:
        performance_latex = df_to_latex(performance_df, performance_std_df, "Performance Metrics", "tab:performance", bold_min_value)
